/**
 * Rellax for foreground/backgrounds
        ...
        if (0 < k.length) {
            ...
            var F,
                ...
                H = function () {
                    ...
                    return (d != l && a.options.vertical) || (c != m && a.options.horizontal)
                        ? !0
                        : !1;
                },
                ...
                h = function () {
                    ...
                    (a.options.wrapper ? a.options.wrapper : document).removeEventListener(
                        "touchmove",
                        h
                    );
                    p = A(G);
...
// Call
// Source: https://dixonandmoe.com/rellax/#GettingStarted
(function () {
